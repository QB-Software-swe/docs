...
\subsubsection{UC 13.2 - Ricezione errore identificativo contatto non valido} \label{sec:UC11.2}
    \begin{itemize}
        \item \textbf{Attore principale}: MUA;
        \item \textbf{Descrizione}: il sistema non riesce a eliminare l'evento perché l'identificativo contatto non è stato trovato;
