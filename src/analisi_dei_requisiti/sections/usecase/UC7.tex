\subsection{UC 7 - Creazione condivisione di una cartella} \label{sec:UC7}
    ...
    \subsubsection{UC 7.1 - Trasmette l'id della cartella} \label{sec:UC7.1}
    \begin{itemize}
        \item \textbf{Attore principale}: MUA;
    ...
    \subsubsection{UC 7.2 - Trasmette l'indirizzo e-mail} \label{sec:UC7.2}
    \begin{itemize}
        \item \textbf{Attore principale}: MUA;
...
\subsubsection{UC 7.3 - Ritorna l'errore cartella non trovata} \label{sec:UC7.3}
    \begin{itemize}
        \item \textbf{Attore principale}: MUA;
    ...
    \subsubsection{UC 7.4 - Ritorna l'errore indirizzo e-mail non valido} \label{sec:UC7.4}
    \begin{itemize}
        \item \textbf{Attore principale}: MUA;
