\subsection{UC 23 - Eliminazione condivisione di una cartella} \label{sec:UC23}
    ...
    \begin{itemize}
        ...
        \item \textbf{Scenario principale}:
            \begin{enumerate}
                ...
                \item il MUA trasmette l'indirizzo e-mail a cui rimuovere la condivisione della cartella (\hyperref[sec:UC23.2]{UC 23.2});
                \item il sistema rimuove la condivisione della cartella.
            \end{enumerate}
    ...
    \subsubsection{UC 23.2 - Trasmette indirizzo contatto} \label{sec:UC23.2}
    \begin{itemize}
        \item \textbf{Attore principale}: MUA;
        ...
        \item \textbf{Scenario principale}:
            \begin{enumerate}
                \item il MUA invia l'indirizzo e-mail a cui togliere la condivisione della cartella al sistema;
...
\subsubsection{UC 23.3 - Ritorna errore cartella non trovata} \label{sec:UC23.3}
    \begin{itemize}
        ...
        \item \textbf{Precondizioni}: il MUA ha inviato l'id della cartella a cui togliere la condivisione al sistema;
