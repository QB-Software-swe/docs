\subsection{UC 9 - Creazione condivisione di un evento} \label{sec:UC9}
    ...
    \subsubsection{UC 9.1 - Trasmette l'id dell'evento} \label{sec:UC9.1}
    \begin{itemize}
        \item \textbf{Attore principale}: MUA;
        ...
        \item \textbf{Scenario principale}:
            \begin{enumerate}
                \item il MUA invia l'id dell'evento per condividere l'evento;
            \end{enumerate}
        \item \textbf{Inclusioni}: nessuna;
        \item \textbf{Generalizzazioni}: nessuna;
...
\subsubsection{UC 9.3 - Ritorna l'errore evento non trovato} \label{sec:UC9.3}
    \begin{itemize}
        \item \textbf{Attore principale}: MUA;
    ...
    \subsubsection{UC 9.4 - Ritorna l'errore indirizzo e-mail non valido} \label{sec:UC9.4}
    \begin{itemize}
        \item \textbf{Attore principale}: MUA;
