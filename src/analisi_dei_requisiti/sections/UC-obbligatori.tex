    ...
    \begin{itemize}
        ...
        \item Scenario principale:
            ...
            \item l'utente selezionala cartella da condividere (\textbf{UC 6.1});
    ...
    \subsubsection{UC 6.1 - Selezionare cartella}
    \begin{itemize}
        \item Attore: utente;
    ...
    \end{itemize}
    \subsubsection{UC 6.2 - Conferma creazione cartella}
    \begin{itemize}
        \item Attore: utente;
    ...
    \begin{itemize}
        ...
        \item Scenario:
        \begin{enumerate}
        \item l'utente seleziona i contatti da aggiungere (\textbf{UC 11.2.1});
        \item l'utente conferma i contatti aggiunti (\textbf{UC 11.2.2}).
        \end{enumerate}
    ...
    \end{itemize}
    \paragraph{UC 11.4.2 - Conferma aggiunta}
    \begin{itemize}
        \item Attore: utente;
