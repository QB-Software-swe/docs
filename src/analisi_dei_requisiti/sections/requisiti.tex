...
\section{Requisiti}
    ...
    \\\hline
    RF & Opzionale & È necessario che il MUA abbia la capacità di creare un evento nel calendario & UC 5
    \\\hline
    RF & Opzionale & È necessario che il MUA abbia la capacità di trasmettere il titolo dell'evento durante l'attività di creazione evento & UC 5.1
    \\\hline
    RF & Opzionale & È necessario che il MUA visualizzi un messaggio d'errore se il titolo trasmesso non è valido durante l'attività creazione evento & UC 5.5
    \\\hline
    RF & Opzionale & È necessario che il MUA abbia la capacità di trasmettere la data di inizio evento durante l'attività di creazione evento & UC 5.2
    \\\hline
    RF & Opzionale & È necessario che il MUA visualizzi un messaggio d'errore se la data trasmessa durante l'attività creazione evento non è valida & UC 5.6
    \\\hline
    RF & Opzionale & È necessario che il MUA abbia la capacità di trasmettere la durata dell'evento durante l'attività di creazione evento & UC 5.3
    \\\hline
    RF & Opzionale & È necessario che il MUA visualizzi un messaggio d'errore se la durata trasmessa è incosistente durante l'attività creazione evento & UC 5.7
    \\\hline
    RF & Opzionale & È necessario che il MUA abbia la capacità di trasmettere la data di fine evento durante l'attività di creazione evento & UC 5.4
    \\\hline
    RF & Opzionale & È necessario che il MUA visualizzi un messaggio d'errore se la data di fine evento trasmessa durante l'attività creazione evento non è valida & UC 5.8
    \\\hline
    RF & Obbligatorio & È necessario che il MUA abbia la capacità di creare una condivisione per una cartella & UC 7
    \\\hline
    RF & Obbligatorio & È necessario che il MUA abbia la capacità di trasmettere l'id della cartella durante l'attività di creazione condivisione cartella & UC 7.1
    \\\hline
    RF & Obbligatorio & È necessario che il MUA visualizzi un messaggio d'errore se l'id cartella trasmesso durante l'attività creazione condivisione cartella non è valido & UC 7.3
    \\\hline
    RF & Obbligatorio & È necessario che il MUA abbia la capacità di trasmettere l'indirizzo contatto durante l'attività di creazione condivisione cartella & UC 7.2
    \\\hline
    RF & Obbligatorio & È necessario che il MUA visualizzi un messaggio d'errore se l'id contatto trasmesso durante l'attività creazione condivisione cartella non è valido & UC 7.4
    \\\hline
    \end{longtable}
